...
abstract class DownloadPlatformInterface {
  ...
  ///
  /// Parameters:
  /// - [filePath]: The path to the file that should be deleted
  ///
  ...
  ///
  /// Parameters:
  /// - [directoryPath]: The path where the directory should be created
  ///
  ...
  ///
  /// Parameters:
  /// - [directoryPath]: The path to the directory that should be deleted
  ///
  ...
  ///
  /// Parameters:
  /// - [directoryPath]: The path to the directory to list files from
  ///
  ...
  ///
  /// Parameters:
  /// - [directoryPath]: The path to the directory to list subdirectories from
  ///
  ...
  /// does not exist.
  Future<List<String>> getDirectoriesInDirectory(String directoryPath);

  Future<String> getQualifiedPathForFile(String filePath);
}
